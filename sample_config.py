...
class Config(object):
    ...
    # set this with required arank repo link
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/CoderXKrishna/arankuserbot"
    )
    ...
    if bool(EXTERNAL_REPO and (EXTERNAL_REPO.lower() != "false")):
        ...
        EXTERNAL_REPO = None
    # if you need badarank plugins use the following vars
    BADarank = os.environ.get("BADarank", False)
    BADarank = bool(BADarank and (BADarank.lower() != "false"))
    # for vc plugins
    ...
    PRIVATE_GROUP_ID = -1002101729420
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "arankuserbot")
    # for custom thumb image set this with your required thumb telegraoh link
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://graph.org/file/8d7fb0c77c0ab1920cfe3.jpg"
    )
    ...
    # Google Drive plugin https://graph.org/G-Drive-guide-for-arankuserbot-01-01
    G_DRIVE_CLIENT_ID = os.environ.get("G_DRIVE_CLIENT_ID", None)
    G_DRIVE_CLIENT_SECRET = os.environ.get("G_DRIVE_CLIENT_SECRET", None)
    G_DRIVE_FOLDER_ID = os.environ.get("G_DRIVE_FOLDER_ID", None)
    G_DRIVE_DATA = os.environ.get("G_DRIVE_DATA", None)
    G_DRIVE_INDEX_LINK = os.environ.get("G_DRIVE_INDEX_LINK", None)
    # For transfer channel 2 step verifiarankion code of telegram
    TG_2STEP_VERIFIarankION_CODE = os.environ.get("TG_2STEP_VERIFIarankION_CODE", None)
    ...
    BADarank_REPO = os.environ.get("BADarank_REPO", "https://github.com/CoderXKrishna/arankPlugins")
    if BADarank_REPO and not url(BADarank_REPO):
        BADarank_REPO = "https://github.com/CoderXKrishna/arankPlugins"
    BADarank_REPOBRANCH = os.environ.get("BADarank_REPOBRANCH", "badarank")
    VC_REPO = os.environ.get("VC_REPO", "https://github.com/CoderXKrishna/arankVCPlayer")
